...
START_TEST(fmod_test) {
  ck_assert_double_eq(fmod(0, 2.5), s21_fmod(0, 2.5));
  ck_assert_double_eq(fmod(2.5, 2.5), s21_fmod(2.5, 2.5));
  ck_assert_float_nan(s21_fmod(9, 0));
  ck_assert_double_eq(fmod(-6, -S21_INF), s21_fmod(-6, -S21_INF));
